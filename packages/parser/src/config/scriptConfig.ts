...
export const SCRIPT_CONFIG = [
  ...
  { scriptString: 'addItem', scriptType: commandType.addItem },
  { scriptString: 'Item', scriptType: commandType.Item },
  { scriptString: 'clearItem', scriptType: commandType.clearItem },
  { scriptString: 'showItem', scriptType: commandType.showItem },
  { scriptString: 'pediaUpdate', scriptType: commandType.pediaUpdate },
  { scriptString: 'presentTheEvidence', scriptType: commandType.presentTheEvidence },
  { scriptString: 'thinking', scriptType: commandType.thinking },
